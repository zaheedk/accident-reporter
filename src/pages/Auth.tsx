    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <h1 className="text-xl font-bold text-foreground tracking-tight">ClaimWise</h1>
          <p className="text-sm text-muted-foreground">{mode === 'login' ? 'Sign in to your account' : 'Create your account'}</p>
        </div>

        {/* OAuth buttons */}
        <div className="space-y-2.5">
          <button onClick={() => handleOAuth('google')} className="btn-secondary w-full h-11 gap-3">
          ...
          <button onClick={() => handleOAuth('apple')} className="btn-secondary w-full h-11 gap-3">
