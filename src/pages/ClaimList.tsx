    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold tracking-tight text-foreground">Accident Reports</h1>
        ...
        {claims.length === 0 ? (
          ...
          <div className="space-y-2">
            {claims.map(c => (
              <div key={c.id} className="card-surface flex items-center justify-between transition-all hover:border-ring">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span className={`text-[10px] font-medium uppercase tracking-widest px-2 py-0.5 rounded ${
                        c.status === 'draft' ? 'bg-accent text-muted-foreground' : 'bg-accent text-foreground'
                      }`}>
                        {c.status}
                      </span>
                    </div>
