          ...
          <div className="flex items-end justify-between gap-3">
            <div className="flex items-start gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-[24px] leading-tight font-semibold text-foreground tracking-[-0.02em] truncate">Tow Companies</h1>
                <p className="text-[12px] text-muted-foreground mt-0.5">Towing services across New Zealand</p>
              </div>
            </div>
          </div>
