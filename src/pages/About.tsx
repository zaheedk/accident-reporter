    ...
    <AppLayout>
      <div className="space-y-8">
        ...
        <div className="card-surface space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Filing a claim after a vehicle incident shouldn't be complicated. We built Fixd to eliminate the paperwork headaches, keep your records organised, and get you back on the road faster.
          </p>
