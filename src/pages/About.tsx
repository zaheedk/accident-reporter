    ...
    <AppLayout>
      <div className="space-y-8">
        ...
        <div className="card-surface space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Filing a claim after a vehicle incident shouldn't be complicated. We built ClaimSorted to eliminate the paperwork headaches, keep your records organised, and get you back on the road faster.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            {[
              { num: '500+', label: 'Claims processed' },
        ...
        <div className="card-surface space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              <Mail className="w-4 h-4 text-primary" /> support@claimsorted.co.nz
            </div>
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
