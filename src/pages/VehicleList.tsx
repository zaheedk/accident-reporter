    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold tracking-tight text-foreground">My Vehicles</h1>
        ...
        {vehicles.length === 0 ? (
          <div className="card-surface text-center py-12">
            ...
            <Link
              to="/vehicles/new"
              className="inline-flex items-center gap-1.5 mt-4 h-9 px-4 bg-primary text-primary-foreground rounded-xl text-xs font-semibold"
              style={{ boxShadow: '0 2px 8px hsl(245 58% 60% / 0.3)' }}
            >
              <Plus className="w-3.5 h-3.5" />
              Add Vehicle
          ...
          <div className="space-y-3">
            {vehicles.map(v => (
              <div key={v.id} className="card-surface flex items-center justify-between transition-all hover:shadow-md">
